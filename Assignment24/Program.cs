...
namespace Assignment24
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            using (FileStream fs = new FileStream("D:\\Simplilearn classes\\day21\\Assignment24\\employee.bin", FileMode.Create))
            {
                formatter.Serialize(fs, employee);
            }
            Console.WriteLine("File created object is Serilized\n");
            using (FileStream fs = new FileStream("D:\\Simplilearn classes\\day21\\Assignment24\\employee.bin", FileMode.Open))
            {
                //formatter.Serialize(fs, employee);
                {
            ...
            using (TextWriter writer = new StreamWriter("D:\\Simplilearn classes\\day21\\Assignment24\\employee.Xml"))
            {
            ...
            using (TextReader reader = new StreamReader("D:\\Simplilearn classes\\day21\\Assignment24\\employee.Xml"))
            {
